...
class BacktestEngine:
    ...
    def _initialize(
        ...
        self._account.balances["USDT"] = Balance(
            asset="USDT",
    ...
    def _run_backtest(
        ...
        for i in range(warmup_period, len(main_bars)):
            # 更新当前时间
            self._current_time = float(main_bars.timestamp[i])
            ...
            bar = Bar(
                ...
                timestamp=float(main_bars.timestamp[i]),
    ...
    def _calculate_equity(self, current_price: float) -> float:
        ...
        # 现金
        equity = self._account.get_total_balance("USDT")
