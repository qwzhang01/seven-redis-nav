...
import type {
    ...
    MarketWSMessageType,
    MarketWSSubscribeParams, SignalKlineResponse, EnumInfoResponse,
} from '../types'
 ...
 * 获取K线数据
 */
export function getKlines(params: KlineParams): Promise<SignalKlineResponse[]> {
 ...
 * 获取交易对列表
 */
export function getSymbols(): Promise<EnumInfoResponse> {
    return get<EnumInfoResponse>('/api/v1/c/enum/TradingPair')
}
 ...
 * 获取市场深度数据
 */
export function getDepthBySymbol(symbol: string, params?: {
    limit?: number
}): Promise<any> {
...
export function createSubscription(data: CreateSubscriptionRequest): Promise<{
    success: boolean;
    message: string;
    ...
    return post<{
        ...
        message: string;
        data: SubscriptionConfig
    }>('/api/v1/m/market/subscriptions', data)
}
 ...
 * 获取订阅统计信息
 */
export function getSubscriptionStatistics(): Promise<{
    success: boolean;
    ...
    return get<{
        success: boolean;
        data: SubscriptionStatistics
    }>('/api/v1/m/market/subscriptions/statistics')
}

/**
 * 获取订阅详情
 */
export function getSubscriptionDetail(subscriptionId: string): Promise<{
    success: boolean;
    data: SubscriptionConfig
}> {
    return get<{
        success: boolean;
        data: SubscriptionConfig
    }>(`/api/v1/m/market/subscriptions/${subscriptionId}`)
}

/**
 * 更新订阅配置
 */
export function updateSubscription(subscriptionId: string, data: UpdateSubscriptionRequest): Promise<{
    success: boolean;
    message: string;
    data: SubscriptionConfig
}> {
    return put<{
        ...
        message: string;
        data: SubscriptionConfig
    }>(`/api/v1/m/market/subscriptions/${subscriptionId}`, data)
}

/**
 * 删除订阅
 */
export function deleteSubscription(subscriptionId: string): Promise<{
    success: boolean;
    message: string
}> {
    return del<{
 ...
 * 启动订阅
 */
export function startSubscription(subscriptionId: string): Promise<{
    success: boolean;
    message: string;
    data: any
}> {
    return post<{
        ...
        message: string;
        data: any
    }>(`/api/v1/m/market/subscriptions/${subscriptionId}/start`)
}

/**
 * 暂停订阅
 */
export function pauseSubscription(subscriptionId: string): Promise<{
    success: boolean;
    message: string;
    data: any
}> {
    return post<{
        ...
        message: string;
        data: any
    }>(`/api/v1/m/market/subscriptions/${subscriptionId}/pause`)
}

/**
 * 停止订阅
 */
export function stopSubscription(subscriptionId: string): Promise<{
    success: boolean;
    message: string;
    data: any
}> {
    return post<{
        ...
        message: string;
        data: any
    }>(`/api/v1/m/market/subscriptions/${subscriptionId}/stop`)
}

// ==================== Admin端同步任务管理接口 ====================

export function createSyncTask(data: CreateSyncTaskRequest): Promise<{
    success: boolean;
    message: string;
    data: SyncTask
}> {
    return post<{
        ...
        message: string;
        data: SyncTask
    }>('/api/v1/m/market/sync-tasks', data)
}
 ...
 * 获取同步任务详情
 */
export function getSyncTaskDetail(taskId: string): Promise<{
    success: boolean;
    data: SyncTask
}> {
    return get<{
        success: boolean;
        data: SyncTask
    }>(`/api/v1/m/market/sync-tasks/${taskId}`)
}

/**
 * 取消同步任务
 */
export function cancelSyncTask(taskId: string): Promise<{
    success: boolean;
    message: string;
    data: any
}> {
    return post<{
        ...
        message: string;
        data: any
    }>(`/api/v1/m/market/sync-tasks/${taskId}/cancel`)
}

// ==================== Admin端历史数据同步接口 ====================

export function createHistoricalSync(data: CreateHistoricalSyncRequest): Promise<{
    success: boolean;
    message: string;
    data: HistoricalSyncTask
}> {
    return post<{
        success: boolean;
        message: string;
        data: HistoricalSyncTask
    }>('/api/v1/m/market/historical-sync', data)
}
 ...
 * 获取历史同步任务详情
 */
export function getHistoricalSyncDetail(taskId: string): Promise<{
    success: boolean;
    data: HistoricalSyncTask
}> {
    return get<{
        success: boolean;
        data: HistoricalSyncTask
    }>(`/api/v1/m/market/historical-sync/${taskId}`)
}

/**
 * 取消历史同步任务
 */
export function cancelHistoricalSync(taskId: string): Promise<{
    success: boolean;
    message: string;
    data: any
}> {
    return post<{
        ...
        message: string;
        data: any
    }>(`/api/v1/m/market/historical-sync/${taskId}/cancel`)
}
 ...
 * 启动同步执行器
 */
export function startHistoricalSyncExecutor(): Promise<{
    success: boolean;
    message: string
}> {
    return post<{
        success: boolean;
        message: string
    }>('/api/v1/m/market/historical-sync/executor/start')
}

/**
 * 停止同步执行器
 */
export function stopHistoricalSyncExecutor(): Promise<{
    success: boolean;
    message: string
}> {
    return post<{
        success: boolean;
        message: string
    }>('/api/v1/m/market/historical-sync/executor/stop')
}
